	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				case 'Brim':
				//BRIM ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('NO BRIM','shared');
				frames = tex;
				animation.addByPrefix('idle', 'NO BRIM idle', 24);
				animation.addByPrefix('singUP', 'NO BRIM up', 24);
				animation.addByPrefix('singRIGHT', 'NO BRIM right', 24);
				animation.addByPrefix('singDOWN', 'NO BRIM down', 24);
				animation.addByPrefix('singLEFT', 'NO BRIM left', 24);
